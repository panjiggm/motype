...
interface SelectProps {
  ...
  emptyLabel?: string
  className?: string
  renderOption: (label: string, fragmentId: number) => ReactElement
}
  ...
  return (
    <div className={className}>
      <div
        ...
        className='flex items-center justify-center h-12 select-none cursor-pointer rounded border border-gray-300 bg-white px-6 pr-5 hover:border-gray-400'
      >
        <span
          className={
